...
INSERT INTO ITEMINFO VALUES(7,'냉동바나나',222000400,6500,'민다나오','필리핀',0,SYSDATE+60,SYSDATE,'freezebanana.PNG',1);
...
insert into iteminfo values(50,'삼겹살',444000200,15000,'한돈','한국',150,sysdate+60,sysdate,'sam.jpg',1);
insert into iteminfo values(51,'목살',444000200,13000,'한돈','한국',180,sysdate+50,sysdate,'mok.jpg',1);
insert into iteminfo values(52,'꽃등심',444000100,25000,'횡성','한국',100,sysdate+30,sysdate,'flower.jpg',1);
insert into iteminfo values(53,'안심',444000100,23000,'횡성','한국',110,sysdate+30,sysdate,'rest.jpg',1);
insert into iteminfo values(54,'생닭',444000300,8000,'하림','한국',200,sysdate+30,sysdate,'dak.jpg',1);
insert into iteminfo values(55,'오리',444000300,12000,'하림','한국',110,sysdate+30,sysdate,'ori.jpg',1);
insert into iteminfo values(56,'제육',444000400,16000,'더본','한국',80,sysdate+15,sysdate,'je.jpg',1);
insert into iteminfo values(57,'불고기',444000400,20000,'더본','한국',110,sysdate+15,sysdate,'bull.jpg',1);
insert into iteminfo values(58,'계란6구',444000500,3000,'양','한국',60,sysdate+20,sysdate,'smallegg.jpg',1);
insert into iteminfo values(59,'계란30구',444000500,5000,'양','한국',110,sysdate+20,sysdate,'bigegg.jpg',1);
insert into iteminfo values(60,'닭가슴살샐러드',444000500,8000,'오빠닭','한국',110,sysdate+7,sysdate,'dakga.jpg',1);
insert into iteminfo values(61,'모듬샐러드',555000100,9000,'샐러드코리아','한국',110,sysdate+7,sysdate,'allsal.jpg',1);
insert into iteminfo values(62,'백도시락',555000200,5000,'더본','한국',110,sysdate+7,sysdate,'backdo.jpg',1);
insert into iteminfo values(63,'옛날도시락',555000100,3000,'도시락킹','한국',110,sysdate+7,sysdate,'olddo.jpg',1);
